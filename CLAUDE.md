...
DSU/cemuhook protocol is the only supported backend. RetroArch is a roadmap goal.
The project is early alpha; preserve working behavior and describe limitations
honestly.
...
- Keep emulator backends separable; future RetroArch support should not be
  coupled into Dolphin configuration or DSU packet construction.
